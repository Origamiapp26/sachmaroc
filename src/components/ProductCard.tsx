      ...
      {product.inStock && (
        <div className="mt-3 px-1">
          <a
            ...
            className="inline-flex w-full items-center justify-center gap-2 rounded-full bg-whatsapp py-2.5 text-xs font-bold text-white shadow-lg transition-all hover:bg-whatsapp-dark"
          >
